            ...
            <div class="container-fluid">
                <div class="panel panel-headline">
                    <div class="panel-heading">
                        <h3 class="panel-title">Unggah Soal</h3>
                    </div>
                            ...
                            <div class="col-md-12 margin-bottom-30">
                                ...
                                <div class="modal fade" id="uploadQuest" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                    <div class="modal-dialog" role="document">
                                        <form method="post" action="{{route('uploadQuestion')}}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                    <h4 class="modal-title" id="myModalLabel">Unggah Soal</h4>
                                                </div>
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="question">File Input</label>
                                                        <input type="file" id="question" name="question" required class="form-control">
...
{{--                                                <a href="#"><i class="fa fa-pencil"></i></a>&ensp;--}}
                                                <a href="{{route('deleteQuestion', $q->id)}}"><i class="fa fa-trash"></i></a>&ensp;
                                                <a href="{{route('downloadQuestion', $q->id)}}"><i class="fa fa-download"></i></a>&ensp;
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
